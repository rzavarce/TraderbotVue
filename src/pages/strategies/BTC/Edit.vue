  ...
  export default {
    ...
    mounted () {
     ...
     .then(response => {
      ...
      console.log(response.data.strategy[0]);
      console.log(response.data.strategy[0].title);

      /*

      this.primitive = {
          "title": response.data.strategy[0].title,
          "currency": response.data.strategy[0].currency,
          ...
          "bear_zone_high": response.data.strategy[0].bear_zone_range.max,
          "bear_zone_low": response.data.strategy[0].bear_zone_range.min,
          "bull_zone_low": response.data.strategy[0].bull_zone_range.min,
          "bull_zone_high": response.data.strategy[0].bull_zone_range.max,

          "bull_mod_low": response.data.strategy[0].bull_mod_range.min,
          "bull_mod_high": response.data.strategy[0].bull_mod_range.max,
          "bear_mod_low": response.data.strategy[0].bear_mod_range.min,
          "bear_mod_high": response.data.strategy[0].bear_mod_range.max,

          "bull_rsi_period": response.data.strategy[0].bull_rsi_period,
          "bear_rsi_period": response.data.strategy[0].bear_rsi_period,

          "ema_large": response.data.strategy[0].ema_zone_range.max,
          "ema_short": response.data.strategy[0].ema_zone_range.min,
          "adx_large": response.data.strategy[0].adx_zone_range.max,
          "adx_short": response.data.strategy[0].adx_zone_range.min,
      ...
      */
      ...
      // this.strategy.title = response.data.strategy[0].title
